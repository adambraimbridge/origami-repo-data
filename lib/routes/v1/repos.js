...
module.exports = app => {
	...
	app.get('/v1/repos/:repoId/versions/:versionId/bundles/:language', requireAuth(requireAuth.READ), validateQueryParams({ errorFor: ['brand'] }), cacheForFiveMinutes, async (request, response, next) => {
		try {
